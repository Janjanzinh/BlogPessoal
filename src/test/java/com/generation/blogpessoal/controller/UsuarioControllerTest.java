...
public class UsuarioControllerTest {
	...
	void start() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Root", "root@root.com", "roottroot", ""));
	}
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService
				.cadastrarUsuario(new Usuario(0L, "Julia Andrews", "juliana_andrews@email.com.br", "Juliana123", "-"));

		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Juliana Andrews Ramos",
				"julia_ramos@email.com.br", "juliana123", "-");
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Ricado Marques","ricardo_marques@email.com.br","ricardo123","-"));
